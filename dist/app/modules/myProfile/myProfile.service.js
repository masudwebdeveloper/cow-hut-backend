...
const myProfile = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.FORBIDDEN, 'not right user');
    }
...
const updateProfile = (token, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_model_1.User.findOneAndUpdate({ _id: id, role }, updatedUserData, {
        new: true,
    });
    return result;
});
