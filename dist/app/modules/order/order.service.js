  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const totalBudget = Number(
        buyerData === null || buyerData === void 0 ? void 0 : buyerData.budget
      );
      ...
      const seller = yield user_model_1.User.findById(
        cowData === null || cowData === void 0 ? void 0 : cowData.seller
      ).session(session);
      let totalIncome = Number(
        seller === null || seller === void 0 ? void 0 : seller.income
      );
...
const getOrders = (paginationOptions, token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const verifiedToken = jwtHelper_1.jwtHelper.verifyToken(
      token,
    ...
    const cowId =
      cow === null || cow === void 0 ? void 0 : cow.map(item => item._id);
    const findCondition =
