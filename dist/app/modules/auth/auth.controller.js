...
const refeshToken = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { refeshToken } = req.cookies;
    const result = yield auth_service_1.AuthService.refeshToken(refeshToken);
    const options = {
        secure: config_1.default.node_env === 'production',
        httpOnly: true,
    };
