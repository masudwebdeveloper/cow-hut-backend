...
const refeshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.FORBIDDEN, 'invalid refesh token');
    }
    ...
    const newAccessToken = jwtHelper_1.jwtHelper.createToken({ id: userId, role }, config_1.default.jwt.access, { expiresIn: config_1.default.jwt.expires_in });
